...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void Jump(InputAction.CallbackContext context)
    {
        if (jumpsRemaining > 0)
        {
            ...
            {
                // holding down jump for full height
        ...
        {
            // tapping the jump button for half height
        ...
        if (context.performed && wallJumpTimer > 0f)
        {
            ...
            Invoke(nameof(CancelWallJump), 0.1f);
            // initially, it was Invoke(nameof(CancelWallJump), wallJumpTime + 0.1f); but I removed it to give a Hollow Knight Claw Grip effect
            // wall jump = 0.5f -- jump again = 0.6f
        }
    }
